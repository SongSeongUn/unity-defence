...
namespace Common
{
    ...
    public class TextExtension : MonoBehaviour
    {
        ...
        public string TextValue
        {
            ...
            set
            {
                if (type == TextType.Legacy) _text.text = value;
                else _tmPro.text = value;
            }
        }
        ...
        public void SetTextSiblingIndex(int siblingIndex, params  object[] args)
        {
            var table = DataTableManager.GetTable<StringTable>();
            if (table == null) return;

            var str = table.GetString(siblingIndex);
            SetText(str, args);
        }
        ...
        public void SetText(string str, params  object[] args)
        {
            try
            {
                TextValue = string.Format(str, args);
            }
            catch (Exception e)
            {
                Console.WriteLine(e);
